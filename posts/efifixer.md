---
title: EFI MAGIC FIXER
date: 2024-12-09
description: EFI partition to resolves issues such as broken EFI partition and EFI not enough disk space.
image: /assets/img/Post/efimagicfix.png
author: "cmalf"
---
...
> This script Tools is Multingual
{: .prompt-tip }


- For source code other langs
    visit my repo [efi-magic-fix](https://github.com/cmalf/efi-magic-fix)

## ScreenShoot

![efi-magic-fix](assets/img/Post/efi-magic-fix/Screenshot 2024-11-18 at 14.18.55.png)